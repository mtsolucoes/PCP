<div class="container text-center">
    ...
    <a class="float-left btn btn-primary btn-search d-inline-block ml-3" href="<?php echo BASE_URL; ?>controle/edit?id=<?php echo $viewData['id'] ?>"><i class="fas fa-edit"></i> Alterar</a>
    <h3 class="d-inline-block">Controle de Produção</h3>
</div>
<div class="container">
    <div class="form-row">
